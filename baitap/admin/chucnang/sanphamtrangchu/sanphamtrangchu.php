...
<?php 
    ...
    $tv="select count(id) from sanpham where trangchu='co' ";
    ...
    $tv="select id,ten,gia,hinhanh,sapxeptrangchu from sanpham where trangchu='co' order by sapxeptrangchu desc limit $vtbd,$so_dong_tren_mot_trang";
    ...
    <table width="990px" class="tb_a1" >
        ...
        <?php 
            ...
            while($tv_2=mysqli_fetch_array($tv_1))
            {
                ...
                $sap_xep_trang_chu=$tv_2['sapxeptrangchu'];
