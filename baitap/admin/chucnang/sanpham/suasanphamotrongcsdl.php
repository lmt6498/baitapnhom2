...
<?php
    ...
    $ten=str_replace("'","&#39;",$ten);
    $gia=trim($_POST['gia']);
    $trang_chu=$_POST['trangchu'];
    $noi_bat=$_POST['noibat'];
    ...
    if($ten!="")
    {
        $tv_k="select count(*) from sanpham where hinhanh='$ten_file_anh' ";
        ...
        if($tv_k_2[0]==0 or $ten_file_anh_tai_len=="")
        {
            ...
            if($ten_file_anh_tai_len!="")
            {             
                $duong_dan_anh="../hinh_anh/sanpham/".$ten_file_anh_tai_len;
                move_uploaded_file($_FILES['hinh_anh']['tmp_name'],$duong_dan_anh);
                $duong_dan_anh_cu="../hinh_anh/sanpham/".$_POST['ten_anh'];
