...
<?php 
    ...
    {
        $tv="select count(*) from sanpham where thuoc_menu='$id_menu' ";
    }
    $tv_1=mysqli_query($conn, $tv);
    ...
    if($id_menu=="toan_bo_san_pham")
    {
        $tv="select id,ten,gia,hinhanh from sanpham order by id desc limit $vtbd,$so_dong_tren_mot_trang";
    }
    else 
    {
        $tv="select id,ten,gia,hinhanh from sanpham where thuoc_menu='$id_menu' order by id desc limit $vtbd,$so_dong_tren_mot_trang";
    }
    $tv_1=mysqli_query($conn,$tv);
?>
