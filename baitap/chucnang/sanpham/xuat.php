<?php 
    ...
    $so_du_lieu=15;
    $tv="select count(*) from sanpham where thuoc_menu='$id';";
    ...
    $tv="select id,ten,gia,hinhanh,thuoc_menu from sanpham where thuoc_menu='$id' order by id desc limit $vtbd,$so_du_lieu";
    $tv_1=mysqli_query($conn,$tv);
    echo "<table>";
